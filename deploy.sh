...
#
# ------------------------------------------------------------------------------
# deploy.sh: A shell script to deploy a new version of Gazebosim FrontEnd.
#
...
#     export AUTH0_AUDIENCE="https://gazebosim.org"
#     export AUTH0_REDIRECT="http://integration.gazebosim.org/callback"
#     export API_HOST="https://staging-api.gazebosim.org"
#     export APP_HOST="https://staging-app.gazebosim.org"
#
# * Run:
#
#     ./deploy.sh
...
if [ "$ASSUME_YES" != "true" ] ; then
  read -p "Deploy Gazebo Web Frontend [$APPLICATION_ENVIRONMENT] [y/N]? " -n 1 -r
  echo
  if [[ ! $REPLY =~ ^[Yy]$ ]] ; then
